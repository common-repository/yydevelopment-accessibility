...
function yydev_accessibility_html_output($output_code) {
...
function yydev_accessibility_show_error_message($error_message, $display_inline = "") {
...
} // function yydev_accessibility_show_error_message($error) {
...
function yydev_accessibility_checkbox_isset($post_value) {
...
} // function yydev_accessibility_checkbox_isset($error) {
